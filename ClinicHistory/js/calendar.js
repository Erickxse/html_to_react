document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventContent: function(info){
            return {
                html: `<div style="overflow: hidden; font-size: 12px; position: relative; cursor: pointer;
        ...
        eventMouseEnter: function(mouseEnterInfo){
            ...
            newEl.innerHTML = `
                <div
                    ...
                    style="position: relative; top: 0; left: 0; width: 300px; height: auto;
                    background-color: white; z-index: 1000; border: 1px solid #e2e8f0; border-radius: 0.375rem;
